...
export default {
    setup() {
         ...
         * Los watcher son funciones que nos permiten Escuchar cuando una variable reactiva cambia su valor y entonces podemos 
         *      acceder a su valor antiguo y a su valor nuevo.
         ...
         * Y como segundo valor, serán los valores nuevo y anteriores, que se imprimirán en la consola cada vez que se cambie el 
         *      valor.
         */
        watch(
            () => obj.counter,
